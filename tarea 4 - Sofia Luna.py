...
print(MiSwapCase("ZkibGAi"))#esta prueba la realize porque es la z y es la final 
print(MiSwapCase("HOLA"))# todas mayusculas
print(MiSwapCase("skibidi"))#todas minuculas 
print(MiSwapCase("$iPi"))#con signos
# (1 punto)
# 5. MiCapitalize
# Input: un string
# Output: un string que tenga la primera letra en mayúsculas
def MiCapitalize (input):
    output=input.capitalize()
    return output
# me da la primera letra en mayusculas por la funcion 
print(MiCapitalize ("input"))#prueba con minusculas
print(MiCapitalize ("HUIF"))#con mayusculas
print(MiCapitalize ("hkasF"))#con una minuscula y demas mayusculas
print(MiCapitalize ("$consi"))#consignos , no hace nada, no puedes poner un signo en mayuscula 
# (2 puntos)
# 6. EsPar
...
print(EsPar(6)) #es par
print(EsPar(5))# no es par 
